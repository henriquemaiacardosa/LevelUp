...
describe('POST /api/auth/login (RF02)', () => {
  ...
  it('deve retornar 200 e um token quando as credenciais forem válidas', async () => {
    authService.login.mockResolvedValue({
      token: 'token-jwt-falso-para-teste',
      usuario: { id_usuario: 5, nome: 'Ana Beatriz', email: 'ana@universidade.edu.br' },
    });
    ...
    expect(resposta.body.token).toBe('token-jwt-falso-para-teste');
  });
